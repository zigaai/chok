...
import com.foo.infra.security.processor.usernamepassword.SysUsernamePasswordToken;
...
public class DaoMultiAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public DaoMultiAuthenticationProvider(StrategyFactory<SysUserType, MultiAuthenticationUserDetailsService> userDetailsServiceStrategy) {
        this(new BCryptPasswordEncoder(), userDetailsServiceStrategy);
    }
    ...
    public DaoMultiAuthenticationProvider(PasswordEncoder passwordEncoder,
                                          StrategyFactory<SysUserType, MultiAuthenticationUserDetailsService> userDetailsServiceStrategy) {
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication)
        ...
        try {
            UserDetails loadedUser = userDetailsServiceStrategy.getStrategy(userType).loadUserByUsername(username);
            if (loadedUser == null) {
    ...
    protected Authentication createSuccessAuthentication(Object principal, Authentication authentication,
        ...
        SysUsernamePasswordToken result = SysUsernamePasswordToken.authenticated(principal, authentication.getCredentials(),
                systemUser.getUserType(), this.authoritiesMapper.mapAuthorities(systemUser.getAuthorities()));
